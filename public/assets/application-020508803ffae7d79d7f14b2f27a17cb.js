...
(function() {
  load("games#new", function(controller, action) {
    var check_game_completed, max_time, playing, save_time_left, saved, time, update_scores, update_time_score, update_timer;
    ...
    update_scores = function() {
      return $('#score').html(gon.score + " puntos");
    };
    update_timer = function() {
      return $('#clock').html(time);
    };
    update_time_score = function() {
      return $('#timescore').html(time / 5 + " puntos por tiempo ");
    };
    return save_time_left = function() {
      return $.get(gon.save_time_left_path, {
        time_left: time
      });
    };
  });
